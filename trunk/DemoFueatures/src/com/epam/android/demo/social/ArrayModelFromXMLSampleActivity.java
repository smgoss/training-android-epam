...
import com.epam.android.demo.common.BaseArrayModelFromXmlAcivity;
import com.epam.android.demo.social.model.Item;

public class ArrayModelFromXMLSampleActivity extends
		BaseArrayModelFromXmlAcivity<Item> {
	...
	private static final String TAG = ArrayModelFromXMLSampleActivity.class
			.getSimpleName();
	...
	protected void success(List<Item> result) {
		...
		Toast.makeText(this, "Load " + result.size() + " items",
