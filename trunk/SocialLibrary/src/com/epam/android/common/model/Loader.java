...
public class Loader {
	...
	public Loader(Context context) {
		httpClient = (HttpClient) context.getApplicationContext()
	...
	public <T> T loadModel(String url, IModelCreator<T> modelCreator)
		...
		return modelCreator.create(new JSONObject(httpClient
	...
	public <T> List<T> loadArrayModel(String url, IModelCreator<T> modelCreator)
		...
		return modelCreator.createArray(new JSONArray(httpClient
				.execute(new HttpGet(url))));
	}
