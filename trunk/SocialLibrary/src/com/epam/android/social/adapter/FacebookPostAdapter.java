...
public class FacebookPostAdapter extends AbstractAdapter<Tweet> {

	private static final String TAG = FacebookPostAdapter.class.getSimpleName();

	public FacebookPostAdapter(Context c, int pItemResource, List<Tweet> pList) {
	...
	public void init(View view, Tweet item) {
		...
		TextView postText = (TextView) view.findViewById(R.id.tweetText);
